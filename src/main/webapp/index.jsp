...
<body ng-app="myApp">
	...
	<section class="main-section" id="service">
		...
		<div class="container">
			<h2>Services</h2>
			<h6>Say What You Want...We Deilver</h6>
			<div class="row">
	...
	<section class="main-section paddind" id="Portfolio">
		...
		<div class="container">
			<h2>Services</h2>
			<h6>Services we Provides....</h6>
			<div class="portfolioFilter">
				<ul class="Portfolio-nav wow fadeIn delay-02s">
					<li><a href="#" data-filter="*" class="current">All</a></li>
					<li><a href="#" data-filter=".branding">Shopping</a></li>
					<li><a href="#" data-filter=".webdesign">Bring up buddies</a></li>
					<li><a href="#" data-filter=".printdesign">Guess and Win</a></li>
					<li><a href="#" data-filter=".photography">Content Writting</a></li>
					<li><a href="#" data-filter=".learn"> Learn new Things</a>
				</ul>
			</div>
	...
	<div class="footer">
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<a class="navbar-brand" href=".#!"><span> ©2018
				...
				<ul class="nav navbar-nav navbar-right">
					<li><a href="#">iFeElZ<span
							class="glyphicon glyphicon-heart"></span></li>
				</ul>
			</div>
			</div>
	</nav>
